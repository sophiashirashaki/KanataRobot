...
async def inline_help_func(__HELP__):
    ...
    answerss = [
        InlineQueryResultArticle(
            ...
            thumb_url="https://telegra.ph/file/f3027484f14646e94a53a.jpg",
...
async def alive_function(answers):
    ...
    buttons.add(
        InlineKeyboardButton("Main bot", url="https://t.me/Kanatapro_bot"),
        InlineKeyboardButton(
    ...
    msg = f"""
**[Kanata ❤️](https://t.me/Kanatapro_bot):**
**MainBot:** `{bot_state}`
**UserBot:** `{ubot_state}`
...
**Profiles:** [BOT](t.me/{BOT_USERNAME}) | [UBOT](t.me/erosei_1)
"""
    answers.append(
        InlineQueryResultArticle(
            title="Alive",
...
async def music_inline_func(answers, query):
    ...
    group_invite = "https://telegra.ph/file/f3027484f14646e94a53a.jpg"
    try:
        messages = [
            m
